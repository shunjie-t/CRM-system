...
<body>
	<?php
         ...
         $gettingID = new userController();
         $gettingID->displayDoctorID($name);
         $doctorID = $gettingID -> getDoctorID();
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="card">
                    ...
                    <div class="card-body">
					 <h3>
                            Referrals Done By <?php echo $name ?>
                    ...
                    <div class="table-responsive">
                            ...
                            <form action="createReferral.php"> 
			                 <button name="id" value=<?php echo $name?>>Create Referral</button> 
			                </form>
                            <form action="viewMyReferred.php"> 
			                    <button name="id">View Patients Referred to You</button> 
			                </form>   
                            </div>
				</div>
			</div>
