			...
			<div class="col-md-12">
				<div class="card">
                    ...
                    <?php
                        ...
                        $patientId = $_GET['id'];
                        $id =  $database->getReference('medicalRecords')->push()->getKey();
                        $medicalRecord->setRecords($id);
                        $medicalRecord->setPatientName($patientId);
                   ?>
						<h3>
							Medical Record for <?php echo $medicalRecord->getPatientName(); ?>
                    ...
                    <div class="card-body">
                        <details open>
                            <summary><h4 class="inlineStyle">Medical Records</h4></summary>
